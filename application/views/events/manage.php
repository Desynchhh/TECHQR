...
<div class="row">
	...
	<div class="col-md-4">
		...
		<div class="event-reset-button">
			<button type="button" class="btn btn-danger" onclick="resetEvent('<?= base_url('events/reset/'.$e_id.'/1'); ?>')">Reset event</button>
		</div>
		<div class="event-reset-button">
			<button type="button" class="btn btn-danger" onclick="resetEvent('<?= base_url('events/reset/'.$e_id); ?>')">Reset event med samme hold</button>
		</div>
	</div>
</div>
