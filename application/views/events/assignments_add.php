	...
	<table class="table">
		<tbody>
			...
			<tr>
				...
				<td><?= $ass['notes'] ?></td>
				<td>
					<a href="<?= base_url("events/add_ass/$e_id/$ass[ass_id]"); ?>">
						<button type="button" id="assAdd<?= $ass['ass_id'] ?>" class="btn btn-sm btn-secondary" onclick="disableButton('assAdd<?= $ass['ass_id'] ?>')">Tilføj</button>
					</a>
				</td>
			</tr>
			<?php endforeach;?>
